...
def salvar_resumo(df_sinalizado, file_path):
    ...
    # Filtrar as linhas sinalizadas (onde 'Sinalização' contém 'Alarme')
    linhas_sinalizadas_com_alarme = df_sinalizado[df_sinalizado['Sinalização'].str.contains('Alarme', na=False)]
    
    # Contagem de acertos por tipo de acerto na coluna "Tipo de Acerto"
    acertos_diretos = linhas_sinalizadas_com_alarme[linhas_sinalizadas_com_alarme['Tipo de Acerto'] == 'Acerto Direto'].shape[0]
    acertos_gale = linhas_sinalizadas_com_alarme[linhas_sinalizadas_com_alarme['Tipo de Acerto'] == 'Acerto Gale'].shape[0]
    erros = linhas_sinalizadas_com_alarme[linhas_sinalizadas_com_alarme['Tipo de Acerto'] == 'Erro'].shape[0]
    
    # Extrair sequências de acertos seguidos de erro, acerto gale e acerto direto
    ...
    for i in range(1, len(linhas_sinalizadas_com_alarme)):
        prev_tipo = linhas_sinalizadas_com_alarme.iloc[i-1]['Tipo de Acerto']
        tipo_atual = linhas_sinalizadas_com_alarme.iloc[i]['Tipo de Acerto']
        
        # Analisando sequências de acertos seguidos de erro
        ...
        # Analisando sequências de erros seguidos de erro
    ...
    return acertos_diretos, acertos_gale, erros, acertos_seguidos_de_erro, acertos_seguidos_de_acerto_gale, acertos_seguidos_de_acerto_direto, erros_seguidos_de_erro, erros_seguidos_de_acerto_gale, erros_seguidos_de_acerto_direto, directory
